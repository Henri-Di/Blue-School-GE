...
<head>
	...
	<link rel="stylesheet" href="BlueColor.css">
				<title>Blue School - Contratos e serviços</title>		
...
<body onload="myFunction()" style="margin:0;">
	...
	<!-- Fim container variavel sessão -->
		<div class="container" id="blue-text-separador">Contratos e serviços</div>	
		<div class="row">	
			<div class="col" id="perfil-blue" onclick="">Novo contrato<br>
			<img src="./imagens/cadastro.png" width="25pt" height="25pt">
			</div>
	
			<div class="col" id="perfil-blue" onclick= "">Novo serviço<br>
			<img src="./imagens/cadastro.png" width="25pt" height="25pt">
			</div>
			
			<div class="col" id="perfil-blue" onclick="">Meus contratos<br>
			<img src="./imagens/meus-contratos.png" width="25pt" height="25pt">
			</div>
			
			<div class="col" id="perfil-blue" onclick="">Serviços solicitados<br>
			<img src="./imagens/servico.png" width="25pt" height="25pt">
			</div>
		</div>
	</div>

...
<head>
	...
	<link rel="stylesheet" href="BlueColor.css">
				<title>Blue School - Painel Financeiro</title>		
...
<body  oncontextmenu="return false" onload="myFunction()" style="margin:0;">
	...
	<br>	
			<div class="container">
				...
				<thead>
					...
					<div class="col" id="text-sub-menu-painel-two" onclick="window.location.href='ExitBlue.php';">Minhas planilhas</div>
					<div class="col" id="text-sub-menu-painel-three" onclick="window.location.href='';">Calculadora</div>
					</div>
					</div>
					</td>
					<td>
	...
	<div class="row" id="blue-painel-restrito">
		<div class="container" id="blue-text-separador">Módulo Financeiro</div>
		<div class="col" id="blue-box-restrito" onclick="window.location.href='PePGestor.php';">Fluxo de caixa<br>
			<img src="./imagens/fluxo-de-caixa.png" width="25pt" height="25pt"/>
		</div>
	
		<div class="col" id="blue-box-restrito" onclick="window.location.href='CeSGestor.php';">Divídas acadêmicas<br>
			<img src="./imagens/conta.png" width="25pt" height="25pt"/>
		</div>
	
		<div class="col" id="blue-box-restrito" onclick="window.location.href='CadastroColaborador.php';">Movimentações financeiras<br>
			<img src="./imagens/apresentacao-financeira.png" width="25pt" height="25pt"/>
		</div>
	</div>
	...
	<div class="row" id="blue-painel-restrito">
		...
		<div class="col" id="blue-box-restrito" onclick="window.location.href='DadosColaborador.php';">Indíce de inadiplência<br>
			<img src="./imagens/perda-de-dinheiro.png" width="25pt" height="25pt"/>
		</div>
	
		<div class="col" id="blue-box-restrito">Relação de gastos<br>
			<img src="./imagens/queimando.png" width="30pt" height="30pt"/>
		</div>
	
		<div class="col" id="blue-box-restrito">Mensalidades acadêmicas<br>
			<img src="./imagens/forma-de-pagamento.png" width="30pt" height="30pt"/>
		</div>
	</div>
	<!-- Fim container painel financeiro -->
	...
	<div class="row" id="blue-painel-restrito">
		...
		<div class="col" id="blue-box-restrito" onclick="window.location.href='DadosColaborador.php';">Compras e serviços<br>
			<img src="./imagens/ir-as-compras.png" width="25pt" height="25pt"/>
		</div>
	
		<div class="col" id="blue-box-restrito">Pagamentos<br>
			<img src="./imagens/pagamento.png" width="30pt" height="30pt"/>
		</div>
	
		<div class="col" id="blue-box-restrito">Relátorios financeiros<br>
			<img src="./imagens/relatorio-de-lucro.png" width="30pt" height="30pt"/>
		</div>
	</div>
	<!-- Fim container painel financeiro -->
</div>	

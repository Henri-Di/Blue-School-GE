...
<head>
	...
	<link rel="stylesheet" href="BlueColor.css">
				<title>Blue School - Painel Matricula</title>		
...
<body  oncontextmenu="return false" onload="myFunction()" style="margin:0;">
	...
	<div class="row" id="blue-painel-restrito">
		<div class="container" id="blue-text-separador">Módulo Matricula</div>
		<div class="col" id="blue-box-restrito" onclick="window.location.href='CadastroAcadêmico.php';">Novo acadêmico<br>
	...
	<div class="row" id="blue-painel-restrito">
		...
		<div class="col" id="blue-box-restrito" onclick="window.location.href='DadosColaborador.php';">Relátorio de inadimplentes<br>
			<img src="./imagens/perda-de-dinheiro.png" width="25pt" height="25pt"/>
		</div>
	
		<div class="col" id="blue-box-restrito">Cronograma acadêmico<br>
			<img src="./imagens/cronograma.png" width="25pt" height="25pt"/>
		</div>
	
		<div class="col" id="blue-box-restrito">Eventos acadêmicos<br>
	...
	<div class="row" id="blue-painel-restrito">
		...
		<div class="col" id="blue-box-restrito" onclick="window.location.href='DadosColaborador.php';">Datas importantes<br>
			<img src="./imagens/calendario.png" width="25pt" height="25pt"/>
		</div>
	
		<div class="col" id="blue-box-restrito">Contrato acadêmico<br>
			<img src="./imagens/contrato.png" width="25pt" height="25pt"/>
		</div>
	
		<div class="col" id="blue-box-restrito">Tabela de preços<br>

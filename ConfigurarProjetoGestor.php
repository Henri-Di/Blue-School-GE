...
<head>
	...
	<link rel="stylesheet" href="BlueColor.css">
				<title>Blue School - Configurar Projeto</title>		
...
<body  oncontextmenu="return false" onload="myFunction()" style="margin:0;">
	...
	<br>
	<div class="container" id="blue-text-separador">Configurações do Projeto</div><br>
		...
		?> 
			...
			<thead>
				<tr>
					...
					<td>
					<div id="blue-title-table-cdst">Projeto</div>
					<div class="form-group">
					<br>
			...
			<div class="col" id="perfil-blue" onclick="window.location.href='EditarProjetoGestor.php?id=<?php echo $dado['ID'];?>';">Editar Projeto<br>
			<img src="./imagens/editar-arquivo.png" width="25pt" height="25pt">
			</div>
	
			<div class="col" id="perfil-blue" onclick= "window.location.href='DeleteProjetoGestor.php?id=<?php echo $dado['ID'];?>';">Remover Projeto<br>
			<img src="./imagens/lixo.png" width="25pt" height="25pt">
			</div>
			
			<div class="col" id="perfil-blue" onclick="">Visualizar projeto<br>
			<img src="./imagens/visualizar.png" width="25pt" height="25pt">
			</div>
			
			<div class="col" id="perfil-blue" onclick="">Progressão do projeto<br>
			<img src="./imagens/trabalho-em-progresso.png" width="25pt" height="25pt">
			</div>
